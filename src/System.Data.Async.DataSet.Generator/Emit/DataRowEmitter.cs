...
internal static class DataRowEmitter
{
        ...
        ImmutableArray<TableModel> allTables)
    {
        ...
        foreach (var rel in allRelations)
        {
            ...
            var childRowClass = NamingHelper.RowClassName(dataSetName, childTable.Name, childTable.TypedName);
            var childTableClass = NamingHelper.TableClassName(dataSetName, childTable.Name, childTable.TypedPlural);
        ...
        foreach (var rel in allRelations)
        {
            ...
            var parentRowClass = NamingHelper.RowClassName(dataSetName, parentTable.Name, parentTable.TypedName);
            var parentTableClass = NamingHelper.TableClassName(dataSetName, parentTable.Name, parentTable.TypedPlural);
